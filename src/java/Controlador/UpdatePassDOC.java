 ...
 * @author kimbe
 */
@WebServlet(name = "UpdatePassDOC", urlPatterns = {"/UpdatePassDOC"})
public class UpdatePassDOC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DOCENTE_DAO DOCdao=new DOCENTE_DAO();
             ...
             DOCdao.UpdatePassword(idp,nwepass);
          JOptionPane.showMessageDialog(null, "Contraseñá Actualizada");
               request.getRequestDispatcher("ControladorD?accion=cambiarpassword").forward(request, response);
        }else{
