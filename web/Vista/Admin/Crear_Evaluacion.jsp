    <%-- 
    Document   : Crear_Evaluacion
    Created on : nov 4, 2022, 11:52:48 p.m.
    Author     : kimbe
--%>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la Seccion para registrar una nueva Evaluacion, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="Mostrar_Evaluaciones.jsp">Listado de Cursos</a></li>
...
//capturar datos 
 ...
 <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar una nueva Evaluacion</div>
			
				
                <form class="form-padding" method="post" action="${pageContext.request.contextPath}/ControladorG?accion=CrearEvaluacion&id=<%=IDPASS%>" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos de la Evaluacion</legend><br>
                        </div>
                        <div class="col-xs-12 col-sm-6">
				<div class="group-material">
                                    <span>ID Curso</span>
                                    <input type="text" class="material-control tooltips-general" disabled="disabled" name="txtidCurso" placeholder="<%=IDPASS%>" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la clase">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
                                    <span>Nombre de la Evaluacion</span>
					<input type="text" class="material-control tooltips-general" name="txtEvaluacion" placeholder="Prueba de Entrada" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la clase">
					<span class="highlight"></span>
					<span class="bar"></span>
			...
			<div class="group-material">
				...
				<select class="material-control" name="cboPorcentaje" id="Curso" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el grado">
					<option value=0  selected="">Selecciona el Porcentaje</option>
                       ...
                       <div class="col-xs-12">
                            <p class="text-center">
                                <button type="reset" class="btn btn-info" style="margin-right: 20px;"><i class="zmdi zmdi-roller"></i> &nbsp;&nbsp; Limpiar</button>
                                 <input type="submit"  name="accion" class="btn btn-primary " value="Crear Evaluacion">
                           ...
                           <tr>
                              ...
                              <td><%=EVAL.getNombre_EvaluacionE()%></td>
                               ...
                               <td><%=ope%> %</td>
								...
								<td>
                                                                    <a  href="${pageContext.request.contextPath}/ControladorG?accion=EliminarEvaluacion&idE=<%= EVAL.getID_evalucionE()%>&id=<%=IDPASS%>"  title="Eliminar Evaluacion" data-backdrop="false" class="btn btn-danger " data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
