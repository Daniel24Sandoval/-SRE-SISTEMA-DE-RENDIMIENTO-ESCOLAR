<%-- 
    Document   : Mostrar_Asignaturas
    Created on : nov 4, 2022, 10:15:49 p.m.
    Author     : kimbe
--%>
			...
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  ...
				  <li class="active">Listado de Asignaturas</li>
                                  ...
                                  <li>
                                      <a href="Crear_Asignatura.jsp">Nueva Asignatura</a>
                           ...
                           <tr>
                              ...
                              <td><%=ASIG.getID_gradoA()%></td>
                               ...
                               <td><%=ASIG.getEstado_AsigA()%></td>
								...
								<td>
                 <a  href="${pageContext.request.contextPath}/ControladorG?accion=Borrar&id=<%= ASIG.getID_ASIGNATURAA()%>"  title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
