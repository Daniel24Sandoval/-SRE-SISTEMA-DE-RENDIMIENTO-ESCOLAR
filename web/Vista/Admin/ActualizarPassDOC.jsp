<%-- 
    Document   : ActualizarPassDOC
    Created on : oct 30, 2022, 5:45:23 p.m.
    Author     : kimbe
--%>
...
//capturar datos 
    ...
    <form class="container" action="${pageContext.request.contextPath}/UpdatePassDOC?id=<%=IDPASS%>" method="post">
    <div class="centering-wrapper">
      <div class="section1 text-center">
	  
        <div class="primary-header">Cambio de Contraseña de DOCENTES </div>
