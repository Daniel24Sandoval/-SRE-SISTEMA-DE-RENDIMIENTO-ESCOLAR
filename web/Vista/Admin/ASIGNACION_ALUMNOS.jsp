<%-- 
    Document   : ASIGNACION_ALUMNOS
    Created on : nov 6, 2022, 11:32:20 a.m.
    Author     : kimbe
--%>
   ...
   <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation"><a href="${pageContext.request.contextPath}/Vista/Admin/Mostrar_Seccion.jsp">Seccion</a></li>
              <li role="presentation"class="active"><a href="">Inscripcion a Curso</a></li>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la Seccion para Agregar a los Alumnos un Secion de Clase </div>
            </div>
        </div>
			...
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  ...
				  <li class="active">Listado de Secciones</li>
                    ...
                    int idSeccion=Integer.parseInt(request.getParameter("idsecion"));
                    %>
                    <div class="container-fluid">
         
			<div class="alert alert-info text-center" style="margin-top:20px;">
			    <h2 class="text-center all-tittles">Listado de Alumnos Inscritos en la Seccion : <%=idSeccion %></h2>
		</div>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar alumnos..." aria-label="Alumnos" aria-describedby="basic-addon1"> 
            ...
            <div class="div-table">
             <table class="table table-striped">
                        ...
                        ASIGNACION_DAO ASIGDAO1 = new ASIGNACION_DAO();
                       
                        ArrayList<SECCION> SECCIONList = ASIGDAO1.getAllIntegrantesSeccion(idSeccion);
                        Iterator<SECCION> iterator1 = SECCIONList.iterator();
                                  ...
                                  <td><%=SEC.getEstado_seccionS()%> </td>
                                   <td>   
                                     <% 
                                         ...
                                         String estado="";
                                         estado=""+SEC.getEstado_seccionS(); 
   if  (estado.equalsIgnoreCase("ACTIVO")) {   %>
                                          
                                                        
                                                        <form  action="post" action="#" > 
                                                            
<a href="#"type="submit" class="btn btn-success btn-xs ">Activo</a>
 ...
 <a href="#"type="submit" class="btn btn-danger btn-xs" >Inactivo</a>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar alumnos..." aria-label="Alumnos" aria-describedby="basic-addon1"> 
            ...
            <div class="div-table">
             <table class="table table-striped">
                        ...
                        ArrayList<ALUMNO> ALUMNOList = ASIGDAO.getAllAlumnoCond(IDD);
 ...
 <a href="#"type="submit" class="btn btn-danger btn-xs" >Inactivo</a>
						...
						<% }   %>                       
                                 ...
                                 <td>
                                     ...
                                     <a href="${pageContext.request.contextPath}/ControladorG?accion=AsignarAlu&idALU=<%=ALU.getIDALUMMNO()%>&idseccion=<%=idSeccion%>" title="Agregar a Alumno" data-backdrop="false" class="btn btn-success btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span></a>				 	
					</td>
