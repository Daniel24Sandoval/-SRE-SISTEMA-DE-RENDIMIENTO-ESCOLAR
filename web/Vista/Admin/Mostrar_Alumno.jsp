...
<%-- 
    Document   : Mostrar_Alumno
    Created on : oct 23, 2022, 12:52:55 p.m.
    Author     : kimbe
--%>
...
<div class="loading"></div>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar un nuevo Alumno, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				 ...
				 <a href="${pageContext.request.contextPath}/Vista/Admin/Registrar_Alumnos.jsp  ">Nuevo Alumno</a>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar alumnos..." aria-label="Alumnos" aria-describedby="basic-addon1"> 
            ...
            <div class="div-table">
             <table class="table table-striped">
                        ...
                        ArrayList<ALUMNO> ALUMNOList = ALUDAO.getAll();
                    ...
                    %> 
                        <form name="form-edit" action=".." method="post"> <tr>
                              ...
                              <td><%=ALU.getNombreA()%>  <%=ALU.getApellidoA()%> </td>                             
                                 <td><%=ALU.getCorreoA()%> </td>	
                                 <td><%=ALU.getID_RolA()%> </td>
                                 <td><%=ALU.getID_grado()%> </td>
                                 <td><%=ALU.getFCreateA()%></td>
   ...
   if  (estado.equalsIgnoreCase("ACTIVO")) {   %>
                                                        ...
                                                        <form  action="post" action="${pageContext.request.contextPath}/Controlador" > 
                                                            
<a href="${pageContext.request.contextPath}/Controlador?accion=CambiarEstadoALUA&idd=<%=ALU.getIDALUMMNO()%>"type="submit" class="btn btn-success btn-xs ">Activo</a>
						  ...
						  <form  method="post" action="${pageContext.request.contextPath}/Controlador" > 
 <a href="${pageContext.request.contextPath}/Controlador?accion=CambiarEstadoALUI&idd=<%=ALU.getIDALUMMNO()%>"type="submit" class="btn btn-danger btn-xs" >Inactivo</a>
			...
			<a href="<%=ALU.getIDALUMMNO()%>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
			
                        
			 
                <a  href="${pageContext.request.contextPath}/Controlador?accion=Borrar&id=<%=ALU.getIDALUMMNO()%>"  title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
                       

					 
				<a href="${pageContext.request.contextPath}/Vista/Admin/ActualizarPassALU.jsp?idpass=<%=ALU.getIDALUMMNO()%>&correo=<%=ALU.getCorreoA()%>" title="Password" data-backdrop="false" class="btn btn-warning btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-lock"></span></a>
				 
				<a href="${pageContext.request.contextPath}/Vista/Admin/Asignacion_Grado.jsp?idpass=<%=ALU.getIDALUMMNO()%>" title="Agregar Grado" data-backdrop="false" class="btn btn-success btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span></a>				 	
					</td>
