<%-- 
    Document   : Crear_Asignatura
    Created on : nov 1, 2022, 10:53:49 p.m.
    Author     : kimbe
--%>
   ...
   <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation"class="active"><a href="#">Asignatura</a></li>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la Seccion para registrar una nueva Asignatura, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="${pageContext.request.contextPath}/Vista/Admin/Mostrar_Asignaturas.jsp">Listado de Asignaturas</a></li>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar una nueva Asignatura</div>
				
				
                <form class="form-padding" method="post" action="${pageContext.request.contextPath}/ControladorG?accion=CrearAsignatura" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos de la Asignatura</legend><br>
                        </div>
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
                                    <span>Nombre de la clase</span>
					<input type="text" class="material-control tooltips-general" name="txtasignatura" placeholder="Nombre de la clase" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la clase">
                       ...
                       <div class="col-xs-12">
                            <p class="text-center">
                                <button type="reset" class="btn btn-info" style="margin-right: 20px;"><i class="zmdi zmdi-roller"></i> &nbsp;&nbsp; Limpiar</button>
                                 <input type="submit"  name="accion" class="btn btn-primary " value="Crear Asignatura">
