<%-- 
    Document   : Mostrar_Inscripciones
    Created on : nov 6, 2022, 12:00:57 a.m.
    Author     : kimbe
--%>
                           ...
                           <tr>
                              ...
                              <td><%=SEC.getGrado_S()%></td>
                               ...
                               <td><%=SEC.getEstado_seccionS()%></td>
								...
								<td>
                 <a  href="${pageContext.request.contextPath}/Vista/Admin/ASIGNACION_ALUMNOS.jsp?id=<%= SEC.getID_Grado()%>&idsecion=<%= SEC.getID_Seccion_AulaS()%>"  title="Agregar Alumnos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-plus-sign"></span></a>
