<%-- 
    Document   : LOGIN_ALUMNO
    Created on : nov 26, 2022, 9:18:36 a.m.
    Author     : kimbe
--%>
...
<div class="position">
    ...
    <form class="form-sign" action="${pageContext.request.contextPath}/Validar?accion=Validar_ALU" method="post">
