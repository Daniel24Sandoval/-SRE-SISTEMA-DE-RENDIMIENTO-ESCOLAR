<%-- 
    Document   : Login_Docente
    Created on : nov 15, 2022, 9:22:38 p.m.
    Author     : kimbe
--%>
...
<div class="position">
    ...
    <form class="form-sign" action="${pageContext.request.contextPath}/Validar?accion=Validar_D" method="post">
