<%-- 
    Document   : Asignacion_Asitencia
    Created on : nov 30, 2022, 10:23:25 a.m.
    Author     : kimbe
--%>
...
<%
    ...
    DOCENTE_DAO ALUDAO = new DOCENTE_DAO();
                        ...
                        Iterator<ASISTENCIA> iterator = ALUMNOList.iterator();
                         Iterator<ASISTENCIA> iterator1 = ALUMNOList.iterator();
                         ASISTENCIA ALU=new ASISTENCIA();
                         ASISTENCIA ALU1=new ASISTENCIA();
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar la asistencia de los Alumnos de Curso Especifico.
                </div>
            </div>
        </div>
  ...
  <form class="container-md3" action="${pageContext.request.contextPath}/ControladorD?accion=ASIGNARASISTENCIA&idsec=<%=idseccion%>&cont=<%=ALU1.count%>" method="post">
                    ...
                    %> 
                         ...
                         <tr>
                              ...
                              <td> <%=ALU.getID_Seccion_AulaA()%></td>
                                 ...
                                 <td> <input type="checkbox" name="Asistencia<%=ALU.count%>" checked data-toggle="toggle" data-on="ASISTIÓ" data-off="FALTO" data-onstyffle="success" value="ASISTIO"  data-offstyle="danger"></td>
                                 <input type="text" name="IDALUMNO<%=ALU.count%>" value="<%=ALU.getID_ALUMNOA()%> "hidden= "true">
                               ...
                               <input type="submit" style="align-items: center" name="accion" class="btn btn-primary btn-group-sm-2" value="TOMAR ASISTENCIA">
         <br><br>
                                     </form>
