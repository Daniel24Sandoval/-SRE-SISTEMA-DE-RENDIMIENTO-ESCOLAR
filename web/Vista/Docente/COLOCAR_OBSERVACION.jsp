<%-- 
    Document   : COLOCAR_OBSERVACION
    Created on : nov 30, 2022, 7:07:07 p.m.
    Author     : kimbe
--%>
...
<%
    int idseccion=Integer.parseInt(request.getParameter("idseci"));
    int IDALUM=Integer.parseInt(request.getParameter("IDALU"));
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Registre la Observacion e Incidentes Ocurrido
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">AFICHE DE OBSERVACIONES E INCENTES</h2>
         ...
         <form class="container-md3" action="${pageContext.request.contextPath}/ControladorD?accion=ASIGNAROBSER&idseccio=<%=idseccion%>&idalu=<%=IDALUM%>" method="post">

  <div class="form-group">
    <label for="exampleInputEmail1">ASUNTO</label>
    <input type="text   " class="form-control" name="asunto"id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese Asunto">
    <small id="emailHelp" class="form-text text-muted">INGRESO SOLO EL ASUNTO.</small>
  </div>
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Ingrese su Descargo</label>
    <textarea class="form-control" name="descargo" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
  <div class="form-check">
      <input type="checkbox" value="Muy Grave" name="check"class="form-check-input" id="exampleCheck1">
    <label class="form-check-label" for="exampleCheck1">Asunto Muy Grave</label>
  </div>
  <button type="submit" class="btn btn-primary">SUBIR INCIDENTE</button>
            </form>
